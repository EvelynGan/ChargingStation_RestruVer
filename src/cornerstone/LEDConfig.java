...
**/
	...
	public static HashMap<ChargingStationConfig.State, Color> stateSteadyColor = new HashMap<>();
	
	public LEDConfig(){
		stateSteadyColor.put(ChargingStationConfig.State.Authorize, UIBlue);
		stateSteadyColor.put(ChargingStationConfig.State.Authorized, White);
	//	stateSteadyColor.put(ChargingStationConfig.State.Authorizing, ??);
		//Charging is flashing
		stateSteadyColor.put(ChargingStationConfig.State.CPError, UIRed);		
		stateSteadyColor.put(ChargingStationConfig.State.Expire, UIGreen);
		stateSteadyColor.put(ChargingStationConfig.State.Fault, UIRed);
		stateSteadyColor.put(ChargingStationConfig.State.Initialize, UIOrange);
	//	stateSteadyColor.put(ChargingStationConfig.State.Locked, ??);	
		stateSteadyColor.put(ChargingStationConfig.State.NetworkDown, UIRed);
		stateSteadyColor.put(ChargingStationConfig.State.Pause, UIOrange);	
		stateSteadyColor.put(ChargingStationConfig.State.Plugging, UIOrange);
		stateSteadyColor.put(ChargingStationConfig.State.Ready, UIGreen);
		stateSteadyColor.put(ChargingStationConfig.State.Replug, UIRed);
	//	stateSteadyColor.put(ChargingStationConfig.State.Unavailable, ??);		
		stateSteadyColor.put(ChargingStationConfig.State.Unlock, UIGreen);		
		stateSteadyColor.put(ChargingStationConfig.State.Unlocked, UIGreen); //flashing green?
	//	stateSteadyColor.put(ChargingStationConfig.State.Unplug, ?? );
		stateSteadyColor.put(ChargingStationConfig.State.Unregister, UIRed);	
		stateSteadyColor.put(ChargingStationConfig.State.Ventilation, UIOrange);
		stateSteadyColor.put(ChargingStationConfig.State.Startup, UIOrange);
		stateSteadyColor.put(ChargingStationConfig.State.CriticalFault, UIRed);	
	...
	public static Color mapNonflashStateColor(ChargingStationConfig.State state) {
		Color c = Color.BLACK;
		switch (state) {
		case Authorize:
			c = UIBlue;
